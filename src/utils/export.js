 ...
 */
export async function downloadTexture(device, texture, fileName = "drawing.png") {
    ...
    encoder.copyTextureToBuffer({ texture: texture }, { buffer: readBuffer, bytesPerRow: paddedBytesPerRow }, [width, height]);
    ...
    for (let y = 0; y < height; y++) {
        ...
        imageData.data.set(rawData.subarray(srcOffset, srcOffset + unpaddedBytesPerRow), destOffset);
    }
